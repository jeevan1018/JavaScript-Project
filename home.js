        ...
        let dataa = [
            ...
            let womens = dataa.filter(function (value, index, array) {
                return value.category == "Women's clothing";
    
            });
            console.log(womens);
    
            let mens = dataa.filter(function (value, index, array) {
                return value.category == "Men's clothing";
            });
            console.log(mens);
    
            let electronicss = dataa.filter(function (value, index, array) {
                return value.category == "Electronics";
            });
            console.log(electronicss);
    
            let jewelerys = dataa.filter(function (value, index, array) {
            ...
            let jeweleryDisplay = () => {
                ...
                jewelerys.forEach((value, index) => {
                    ...
                    btn.addEventListener("click", () => {
                        ...
                        console.log(jewelerys[index]);
                        localStorage.setItem("addingind", JSON.stringify(jewelerys[index]));
                        window.location.assign("./info.html");
            ...
            let electronicsDisplay = () => {
                ...
                electronicss.forEach((value, index) => {
                    console.log(value);
                    let tablee = document.getElementById("tablee");
                    let createdTr = document.createElement("tr");
                    let createdTd = document.createElement("td");
                    ...
                    btn.addEventListener("click", () => {
                        console.log(electronicss[index]);
                        localStorage.setItem("addingind", JSON.stringify(electronicss[index]));
                        window.location.assign("./info.html");
            ...
            let womensDisplay= () => {
                ...
                womens.forEach((value, index) => {
                    ...
                    btn.addEventListener("click", () => {
                        console.log(womens[index]);
                        localStorage.setItem("addingind", JSON.stringify(womens[index]));
                        window.location.assign("./info.html");
